...
const LoginForm = () => {
  ...
  useEffect(() => {
    // Wait for userInfo to finish loading and be available
    if (
      userInfo.isAuthenticated &&
      !userInfo.loading &&
      userInfo.userType // or userInfo.name, etc.
    ) {
  ...
  }, [userInfo.isAuthenticated, userInfo.loading, userInfo.userType, navigate]);
